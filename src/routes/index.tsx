...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hyderabad Public School Model United Nations 2026 — strategic diplomacy at Warangal, 25–26 July 2026." },
      { property: "og:title", content: "HPSMUN 2026 — Be Vigilant" },
      { property: "og:description", content: "A flagship MUN convening — UNDP, UNGA, WHO, Lok Sabha. Warangal, 25–26 July 2026." },
    ],
  }),
  component: Index,
});
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${
        scrolled ? "backdrop-blur-md bg-background/70 border-b hairline" : "bg-transparent border-b border-transparent"
      }`}
    >
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-5 md:px-12">
        <a href="#top" className="flex items-center gap-3">
          <img src={hpsLogo} alt="The Hyderabad Public School, Warangal" className="h-9 w-9 rounded-full object-cover" />
          <div className="leading-tight">
            <div className="font-serif text-lg tracking-wide">HPSMUN</div>
            <div className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">MMXXVI · Warangal</div>
          </div>
        </a>
        <nav className="hidden items-center gap-10 text-[12px] tracking-eyebrow uppercase text-muted-foreground md:flex">
          <a href="#committees" className="hover:text-foreground transition">Committees</a>
          <a href="#secretariat" className="hover:text-foreground transition">Secretariat</a>
          <a href="#registration" className="hover:text-foreground transition">Registration</a>
      ...
      <div className="mx-auto grid max-w-[1440px] grid-cols-1 gap-16 px-6 pb-24 md:px-12 lg:grid-cols-12 lg:gap-12">
        <motion.div style={{ y, opacity }} className="lg:col-span-7 flex flex-col justify-center">
          ...
          >
            ...
            substantive negotiation, policy authorship, and diplomatic exchange — convened
            on the historic grounds of Hyderabad Public School, Warangal.
          </motion.p>
    ...
    <div className="relative aspect-square w-full max-w-[520px]">
      ...
      >
        <svg viewBox="0 0 100 100" className="h-full w-full">
          ...
          <circle cx="50" cy="50" r="48" fill="none" stroke="rgba(248,250,252,0.18)" strokeWidth="0.25" />
          {/* longitude */}
          {[0, 22.5, 45, 67.5, 90, 112.5, 135, 157.5].map((a) => (
            <ellipse key={a} cx="50" cy="50" rx={48 * Math.abs(Math.cos((a * Math.PI) / 180))} ry="48" fill="none" stroke="rgba(212,175,55,0.18)" strokeWidth="0.18" />
          ))}
          {/* latitude */}
          {[10, 22, 35, 50, 65, 78, 90].map((y) => (
            <ellipse key={y} cx="50" cy={y} rx="48" ry={Math.sin((y / 100) * Math.PI) * 4 + 1} fill="none" stroke="rgba(248,250,252,0.10)" strokeWidth="0.18" />
          ))}
        </svg>
      </motion.div>
  ...
  return (
    <Section eyebrow="The Standard">
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-20">
        <div className="lg:col-span-7">
          <h2 className="font-serif text-[clamp(2.4rem,5vw,4.5rem)] leading-[1.02] tracking-tight text-balance">
            Built for serious <em className="italic text-gold">diplomatic exchange</em> — not theatre.
          </h2>
        </div>
        <div className="lg:col-span-5 lg:pt-6">
          <p className="text-muted-foreground leading-relaxed">
            Each committee is convened with the rigour of a working forum. Delegates are
            expected to research deeply, write substantively, and negotiate with the
            posture of practitioners — not performers.
          </p>
      ...
      <div className="mt-24 border-t hairline pt-12 grid grid-cols-1 gap-12 md:grid-cols-3">
        <Metric kicker="Duration" value="02" suffix="Days" caption="Two consecutive days of substantive debate." />
        <Metric kicker="Participation" value="800" prefix="₹" caption="A single delegate fee. Inclusive of all sessions." />
        <Metric kicker="Forums" value="04" suffix="Committees" caption="Hand-picked agendas across global and national bodies." />
      </div>
    </Section>
  );
}
  ...
  return (
    <div ref={ref}>
      ...
      <div className="mt-4 flex items-baseline gap-2">
        ...
        {suffix && <span className="ml-2 text-xs tracking-eyebrow uppercase text-muted-foreground">{suffix}</span>}
      </div>
...
const committees = [
  {
    ...
    agenda: "Sovereign debt restructuring and its consequences for development finance in the Global South.",
    description:
  ...
  },
  {
    ...
    short: "LS",
    name: "Lok Sabha",
    agenda: "Federalism, fiscal devolution, and the contested architecture of Indian cooperative governance.",
    description:
    ...
    <Section id="committees" eyebrow="The Forums">
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          Four committees. Four agendas authored with deliberate ambition — drawn from the
          most pressing questions in global and Indian governance.
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 border-t hairline pt-6">
        ...
        <p className="mt-3 font-serif text-lg italic leading-snug text-foreground/90">&ldquo;{c.agenda}&rdquo;</p>
      </div>
...
/* ---------- Registration ---------- */
const pathway = [
  { n: "01", t: "Application", d: "Submit your delegate application with committee preferences and a brief statement of intent." },
  { n: "02", t: "Allocation", d: "Receive your committee and portfolio. Background guides are dispatched on the day of allocation." },
  { n: "03", t: "Confirmation", d: "Confirm participation with payment of the ₹800 delegate fee. A formal invitation follows." },
  { n: "04", t: "Conference", d: "Convene at Hyderabad Public School, Warangal on 25–26 July 2026 for two days of substantive debate." },
];
...
const pillars = [
  ...
  { t: "Public Speaking", d: "Moderated caucuses calibrated for clarity, restraint, and persuasion." },
  { t: "Networking", d: "A delegate body curated for substance — peers worth remembering." },
  { t: "Diplomatic Simulation", d: "Procedure honoured. Crisis introduced with intent, not spectacle." },
        ...
        {quotes.map((q, i) => (
          ...
          >
            ...
            <figcaption className="mt-8 border-t hairline pt-5">
              ...
              <div className="mt-1 text-[10px] tracking-eyebrow uppercase text-muted-foreground">{q.r}</div>
            </figcaption>
          </motion.figure>
        ))}
      </div>
    ...
    <section id="venue" className="relative">
      ...
      <div className="relative mt-12">
        <div className="relative aspect-[21/9] w-full overflow-hidden">
          <img src={venueImg} alt="Hyderabad Public School, Warangal at twilight" loading="lazy" width={1920} height={1080} className="h-full w-full object-cover" />
          ...
          <div className="-mt-32 md:-mt-48 relative grid grid-cols-1 gap-10 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 lg:pt-10">
              <dl className="grid grid-cols-2 gap-y-6 border-t hairline pt-8">
                <div><dt className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">Established</dt><dd className="mt-2 font-serif text-2xl">1923</dd></div>
                <div><dt className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">City</dt><dd className="mt-2 font-serif text-2xl">Warangal</dd></div>
                <div><dt className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">State</dt><dd className="mt-2 font-serif text-2xl">Telangana</dd></div>
                <div><dt className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">Distinction</dt><dd className="mt-2 font-serif text-2xl">Academic Heritage</dd></div>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] tracking-eyebrow uppercase text-muted-foreground">Be Vigilant · MMXXVI</div>
              </div>
            </div>
            <p className="mt-6 max-w-sm text-sm text-muted-foreground">
              An annual convening of the Hyderabad Public School Model United Nations
              Society, Warangal. Convened in the tradition of serious diplomatic exchange.
            </p>
          </div>

          <FooterCol title="Conference" items={["Committees", "Secretariat", "Registration", "Venue"]} />
          <FooterCol title="Office" items={["Press", "Partnerships", "Code of Conduct", "Contact"]} />
          <FooterCol title="Correspondence" items={["secretariat@hpsmun.in", "press@hpsmun.in", "+91 · · · · · · · ·"]} />
        </div>
